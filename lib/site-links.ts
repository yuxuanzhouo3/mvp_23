const currentOrigin = process.env.NEXT_PUBLIC_SITE_URL || "https://mornstack.vercel.app"

export const siteLinks = {
  bossDemo: process.env.NEXT_PUBLIC_BOSS_DEMO_URL || `${currentOrigin}/demo`,
  websiteIntl: process.env.NEXT_PUBLIC_WEBSITE_URL_INTL || "https://mornstack.vercel.app",
